...
import { FaBuilding, FaLocationDot, FaLocationPin, FaMessage } from "react-icons/fa6";
            ...
            >
              <div className="flex items-center gap-4 lg:flex-row flex-col-reverse">
                <div className="space-y-7 flex flex-col lg:items-start items-center">
                  <p className="inline-flex items-center gap-2 rounded-full border border-[#dcc4a8] bg-[#f8ead8]/90 px-4 py-2 text-sm font-medium text-zinc-600 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5 dark:text-zinc-300 max-[380px]:px-3 max-[380px]:text-xs " >
                  ...
                  <Link
                      to="/projects"
                      className="inline-flex items-center gap-2 rounded-full border border-[#d6bea0] px-5 py-3 text-sm font-medium text-zinc-900 transition hover:border-[#c9ae8d] hover:bg-[#f1dfca] dark:border-white/10 dark:text-white dark:hover:bg-white/10 max-[380px]:w-fit  max-[380px]:justify-center max-[380px]:px-4 max-[380px]:py-2.5"
                    >
                  ...
                  <div className="space-y-4 text-base leading-7 text-zinc-600 dark:text-zinc-400 sm:text-lg mt-4">
                    <p className="text-pretty max-w-2xl sm:px-0 px-6">
                      I design and build responsive portfolio, product, and
                      business websites with a clean visual language and a
                  ...
                  <div className="flex flex-wrap  max-[380px] gap-4 sm:gap-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-full bg-zinc-950 px-5 py-3 text-sm font-medium text-white transition hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 max-[380px]:w-fit max-[380px]:justify-center max-[380px]:px-4 max-[380px]:py-2.5"
                    >
                      <FaGithub /> GitHub
                    </a>
                    <Link
                ...
                <div className="relative flex justify-center w-full max-w-xl overflow-hidden sm:overflow-visible">
                  ...
                  <div
                    className="relative  rounded-2xl bg-[#f8ead8]/75 shadow-white shadow-[0_30px_50px_-45px_rgba(0,0,0,0.45)] backdrop-blur dark:border-white/10 dark:bg-white/5 w-1/2 lg:flex justify-center">
                    <img
                    ...
                    <div
                      className="group absolute sm:-top-2 top-0 sm:-left-23 -left-14 flex rounded-full bg-white sm:p-6 p-4 shadow-md shadow-stone-500 hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer z-999"
                    ...
                    >
                      ...
                      <div className="pointer-events-none absolute left-full top-1/2 z-50 ml-4 min-w-48 -translate-y-1/2 translate-x-2 scale-95 rounded-2xl border border-stone-200 bg-white/95 px-4 py-3 text-left opacity-0 shadow-xl shadow-stone-500/20 backdrop-blur transition duration-300 ease-out group-hover:translate-x-0 group-hover:scale-100 group-hover:opacity-100 group-focus:translate-x-0 group-focus:scale-100 group-focus:opacity-100">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-stone-500">Experience</p>
                        <p className="mt-1 text-sm font-bold text-stone-900">17 Months</p>
                      </div>
                    </div>

                    <div
                      className="group absolute top-20 sm:top-24 -left-20 flex rounded-full bg-white p-2 sm:p-4 shadow-md shadow-stone-500 hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer"
                    ...
                    >
                      ...
                      <div className="pointer-events-none absolute left-full top-1/2 z-50 ml-4 min-w-56 -translate-y-1/2 translate-x-2 scale-95 rounded-2xl border border-stone-200 bg-white/95 px-4 py-3 text-left opacity-0 shadow-xl shadow-stone-500/20 backdrop-blur transition duration-300 ease-out group-hover:translate-x-0 group-hover:scale-100 group-hover:opacity-100 group-focus:translate-x-0 group-focus:scale-100 group-focus:opacity-100">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-stone-500">Company</p>
                        <p className="mt-1 text-sm font-bold text-stone-900">{currentExperience.company}</p>
                      </div>
                    </div>

                    <div
                      className="group absolute sm:top-48 top-34 -left-18 flex rounded-full bg-white p-2 sm:p-3 shadow-md shadow-stone-500 hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer"
                      aria-label="Degree details"
                      tabIndex={0}
                    >
                      <FaGraduationCap className="z-999 h-5 w-5 text-3xl text-stone-800" />
                      <div className="pointer-events-none absolute left-full top-1/2 z-50 ml-4 min-w-48 -translate-y-1/2 translate-x-2 scale-95 rounded-2xl border border-stone-200 bg-white/95 px-4 py-3 text-left opacity-0 shadow-xl shadow-stone-500/20 backdrop-blur transition duration-300 ease-out group-hover:translate-x-0 group-hover:scale-100 group-hover:opacity-100 group-focus:translate-x-0 group-focus:scale-100 group-focus:opacity-100">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-stone-500">Degree</p>
                        <p className="mt-1 text-sm font-bold text-stone-900">{currentEducation.title}</p>
                        <p className="mt-1 text-xs font-bold text-stone-600">{currentEducation.institution}</p>
                      </div>
                    </div>

                    <div
                      className="group absolute sm:top-72 top-46 -left-12 sm:-left-12 flex rounded-full bg-white p-2 shadow-md shadow-stone-500 hover:scale-90 transition-all duration-300 ease-in-out cursor-pointer"
                    ...
                    >
                      ...
                      <div className="pointer-events-none absolute left-full top-1/2 z-50 ml-4 min-w-56 -translate-y-1/2 translate-x-2 scale-95 rounded-2xl border border-stone-200 bg-white/95 px-4 py-3 text-left opacity-0 shadow-xl shadow-stone-500/20 backdrop-blur transition duration-300 ease-out group-hover:translate-x-0 group-hover:scale-100 group-hover:opacity-100 group-focus:translate-x-0 group-focus:scale-100 group-focus:opacity-100">
                        ...
                        <p className="mt-1 text-sm font-bold text-stone-900">Varanasi, Uttar Pradesh</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-6 space-y-4 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-2">
                      ...
                      <a
                        ...
                        className="rounded-full border border-[#d6bea0] px-4 py-2 text-sm font-medium text-zinc-700 transition hover:bg-[#f1dfca] dark:border-white/10 dark:text-zinc-200 dark:hover:bg-white/10"
                      >
                        Hire Me
                      </a>
                    </div>
                  ...
                  <div className="mx-5 space-y-4 text-zinc-700 mt-4 dark:text-zinc-300 max-[380px]:mx-3">
                    <div className="rounded-2xl border border-[#dcc4a8]/70 bg-[#f1dfca] p-4 dark:border-white/10 dark:bg-white/5">
                      <div className="flex items-start gap-3 sm:text-base text-sm">
                        ...
                        <span className="min-w-0 break-words">khalidraza30565@gmail.com</span>
                      </div>
                    </div>
                    <div className="rounded-2xl border border-[#dcc4a8]/70 bg-[#f1dfca] p-4 dark:border-white/10 dark:bg-white/5">
                      <div className="flex items-start gap-3 sm:text-base text-sm">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="min-w-0 break-words underline decoration-zinc-300 underline-offset-4"
                        >
                          @khalid-raza03
                        </a>
                      </div>
                  ...
                  >
                    <div className="rounded-[1.75rem]   border border-[#dcc4a8]/70 bg-[#f1dfca] dark:bg-transparent sm:p-8 p-4 text-center shadow-[0_20px_45px_-35px_rgba(0,0,0,0.25)] backdrop-blur dark:border-white/10  max-[380px]:p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-6 inline-flex items-center gap-2 rounded-full bg-zinc-950 px-6 py-3 text-sm font-medium text-white transition hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 max-[380px]:w-full max-[380px]:justify-center max-[380px]:px-4 max-[380px]:py-2.5"
                      >
                  ...
                  <div className="rounded-[1.75rem] border border-[#dcc4a8]/70 bg-[#e5cbab]/85 p-8 shadow-[0_20px_45px_-30px_rgba(0,0,0,0.25)] backdrop-blur dark:border-white/10 dark:bg-white/5 max-[380px]:p-6">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                      <div>
                        ...
                        >
                          Passionate frontend developer with over one year of experience building responsive websites and web apps. I focus on polished UI, accessible interfaces, and clear content hierarchy.
                        </ScrollReveal>
                      </div>
                    </div>
                  </div>
